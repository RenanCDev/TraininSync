...
class Pagamento(models.Model):
    ...
    contrato = models.ForeignKey(ContratoDeServico, on_delete = models.CASCADE, related_name="pagamentos")
    ...
    def __str__(self):
        return f"Pagamento de {self.aluno} referente ao contrato {self.contrato} na data {self.data_pagamento} - R$ {self.valor}"
